  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <input
          className="placeholder:italic placeholder:text-slate-400 block bg-white w-96 border 
          border-slate-300 rounded-md py-2 pl-3 pr-3 shadow-sm focus:outline-none focus:border-sky-500 
